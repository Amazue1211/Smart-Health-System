...
const HealthCareDashboard = () => {
  const [unreadCount] = useState(3); // demo value; replace with real data
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Notification Button */}
            <button
              onClick={() => window.location.href = '/notifications'} // replace with your router navigation
              className="relative p-2 text-slate-600 hover:text-blue-600 bg-white/80 backdrop-blur-sm rounded-xl border border-slate-200 hover:border-blue-300 shadow-sm transition-all duration-200"
            >
